...
<!-- =====================end header ==========================-->
	...
	<SCRIPT type="text/javascript" src="resources/js/skatmaintenancenctsimport_dkx001r.js?ver=${user.versionEspedsg}"></SCRIPT>	
		...
		<table width="100%" class="text11" cellspacing="0" border="0" cellpadding="0">
			<tr height="2"><td></td></tr>
				<tr height="25"> 
					...
					<td width="20%" valign="bottom" class="tabDisabled" align="center" nowrap>
						<a id="alinkSadMaintImportKoder" tabindex=-1 style="display:block;" href="skatmaintenancenctsimport_kodergate.do?id=DKXKODF">
					...
					<td width="30%" valign="bottom" class="tab" align="center" nowrap>
						<font class="tabLink">&nbsp;Kodetype&nbsp;<font class="text14">${model.tkunik}&nbsp;${model.legend}</font></font>&nbsp;
						<img style="vertical-align: middle;"  src="resources/images/list.gif" border="0" alt="general list">
					</td>
		...
		<%-- space separator --%>
						...
						<table id="mainList" class="display compact cell-border" >
				            ...
				            <c:forEach var="record" items="${model.list}" varStatus="counter">   
				               ...
				               <td align="center" width="2%" class="tableCell" style="cursor:pointer; border-style: solid;border-width: 0px 1px 1px 0px;border-color:#FAEBD7;">
		               				<a onclick="javascript:return confirm('Er du sikker på at du vil fjerne denne?')" tabindex=-1 href="skatmaintenancenctsimport_dkx001r_edit.do?action=doDelete&id=${model.dbTable}&tkunik=${record.tkunik}&tkkode=${record.tkkode}">
			...
			<tr >
	 	    ...
	 	    <tr >
	 	    	<td width="5%">&nbsp;</td>
				<td width="100%">
				<form action="skatmaintenancenctsimport_dkx001r_edit.do" name="formRecord" id="formRecord" method="POST" >
