 ...
 * @date 	Feb 20, 2014
 */
public class SearchFilterSkatAdminNorskExportList {
	private static final Logger logger = LoggerFactory.getLogger(SearchFilterSkatAdminNorskExportList.class.getName());
