 ...
 * 
 */
public class SkatAdminTransportListValidator implements Validator {

	/**
	 * 
	 */
	public boolean supports(Class clazz) {
		return SearchFilterSkatAdminTransportList.class.isAssignableFrom(clazz); 
	}
	...
	public void validate(Object obj, Errors errors) { 
		SearchFilterSkatAdminTransportList record = (SearchFilterSkatAdminTransportList)obj;
		...
		if(record!=null){
			...
			if( !this.valueExists(record.getAvd()) && !this.valueExists(record.getSign()) ){
				if( this.valueExists(record.getOpd()) ||  
					...
					ValidationUtils.rejectIfEmptyOrWhitespace(errors, "avd", "systema.skat.admin.transport.list.error.null.avdOrSign"); 
				}
			}
