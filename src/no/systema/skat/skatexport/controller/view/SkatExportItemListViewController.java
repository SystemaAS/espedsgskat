...
public class SkatExportItemListViewController {
	private static final Logger logger = LoggerFactory.getLogger(SkatExportItemListViewController.class.getName());
	 ...
	 * 
	 */
	@RequestMapping(value="skatExportListExcelView.do", method={RequestMethod.GET})
	public ModelAndView getItemListExcelView(HttpSession session, HttpServletRequest request, HttpServletResponse response){
		...
		final String EXCEL_VIEW = "skatExportItemListExcelView";
		
		SystemaWebUser appUser = (SystemaWebUser)session.getAttribute(AppConstants.SYSTEMA_WEB_USER_KEY);
		List<JsonSkatExportSpecificTopicItemRecord> itemList = null;
