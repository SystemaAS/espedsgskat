...
/**
 * SKAT NCTS Import Unloading Header Controller - child windows popup
 * 
...
@Scope("session")
public class SkatNctsImportUnloadingHeaderControllerChildWindow {
	
	private static final Logger logger = LoggerFactory.getLogger(SkatNctsImportUnloadingHeaderControllerChildWindow.class.getName());
	 ...
	 * @return
	 */
	@RequestMapping(value="skatnctsimport_unloading_edit_childwindow_generalcodes.do", params="action=doInit",  method={RequestMethod.GET} )
	public ModelAndView doInitGeneralCodes(@ModelAttribute ("record") JsonSkatNctsCodeRecord recordToValidate, HttpSession session, HttpServletRequest request){
		...
		ModelAndView successView = new ModelAndView("skatnctsimport_unloading_edit_childwindow_generalcodes");
