...
@Scope("session")
public class MaintSkatNctsImportKoderGateController {
	private static final JsonDebugger jsonDebugger = new JsonDebugger();
	private static final Logger logger = LoggerFactory.getLogger(MaintSkatNctsImportKoderGateController.class.getName());
	 ...
	 * @return
	 */
	@RequestMapping(value="skatmaintenancenctsimport_kodergate.do", method=RequestMethod.GET)
	public ModelAndView doSkatImportList(HttpSession session, HttpServletRequest request){
		ModelAndView successView = new ModelAndView("skatmaintenancenctsimport_kodergate");
	...
	private List<MaintenanceMainListObject> populateMaintenanceMainList(){
		...
		object = new  MaintenanceMainListObject();
		object.setId("20");
		object.setSubject("Statuskoder import");
		object.setCode("301");
		object.setText("DKX001R / DKXKODF");
		object.setDbTable("DKXKODF");
		object.setPgm("dkx001r");
