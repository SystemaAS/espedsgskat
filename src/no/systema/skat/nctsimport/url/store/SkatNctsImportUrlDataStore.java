...
public final class SkatNctsImportUrlDataStore {
	...
	//[1] FETCH ARENDE LIST
	//----------------------------
	@UrlDataStoreAnnotationForField (name="@SkatNctsImportController - skatnctsimport action=doFind ", description=" --> NCTS_IMPORT_BASE_TOPICLIST_URL")
	...
	//---------------------------------------------------------------
	@UrlDataStoreAnnotationForField (name="@SkatNctsImportHeaderController/@SkatNctsImportUnloadingHeaderController - skatnctsimport_edit.do/skatnctsimport_unloading_edit.do ", description=" --> NCTS_IMPORT_BASE_FETCH_SPECIFIC_TOPIC_URL")
	...
	//mode=S (Send topic)
	//------------------------------		
	@UrlDataStoreAnnotationForField (name="@SkatNctsImportHeaderController - skatnctsimport_edit.do ", description=" --> NCTS_IMPORT_BASE_UPDATE_SPECIFIC_TOPIC_URL")
	...
	//Refresh ARENDE
	@UrlDataStoreAnnotationForField (name="@SkatNctsImportItemsController/@SkatNctsImportUnloadingItemsController - skatnctsimport_unloading_edit_items.do ", description=" --> NCTS_IMPORT_BASE_REFRESH_SPECIFIC_TOPIC_URL")
	...
	//------------------------------------------
	@UrlDataStoreAnnotationForField (name="@SkatNctsImportItemsController - skatnctsimport_edit_items.do ", description=" --> NCTS_IMPORT_BASE_FETCH_TOPIC_ITEMLIST_URL")
	...
	@UrlDataStoreAnnotationForField (name="@SkatNctsImportAjaxHandlerController - getSpecificTopicItemChosenFromGuiElement_SkatNctsImport.do ", description=" --> NCTS_IMPORT_BASE_FETCH_SPECIFIC_TOPIC_ITEM_URL")
	...
	//mode=D (Delete existing topic)
	//---------------------------------------------
	@UrlDataStoreAnnotationForField (name="@SkatNctsImportItemsController - skatnctsimport_edit_items.do ", description=" --> NCTS_IMPORT_BASE_UPDATE_SPECIFIC_TOPIC_ITEM_URL")
	...
	//--------------------------------------
	@UrlDataStoreAnnotationForField (name="@SkatNctsImportUnloadingHeaderController - skatnctsimport_unloading_edit.do ", description=" --> NCTS_IMPORT_BASE_FETCH_SPECIFIC_TOPIC_UNLOADING_URL")
	...
	//----------------------------------------
	@UrlDataStoreAnnotationForField (name="@SkatNctsImportUnloadingHeaderController - skatnctsimport_unloading_edit.do ", description=" --> NCTS_IMPORT_BASE_UPDATE_SPECIFIC_TOPIC_UNLOADING_URL")
	...
	//-------------------------------------------------------
	@UrlDataStoreAnnotationForField (name="@SkatNctsImportUnloadingItemsController - skatnctsimport_unloading_edit_items.do ", description=" --> NCTS_IMPORT_BASE_FETCH_TOPIC_UNLOADING_ITEMLIST_URL")
	...
	@UrlDataStoreAnnotationForField (name="@SkatNctsImportAjaxHandlerController - getSpecificTopicUnloadingItemChosenFromGuiElement_SkatNctsImport.do ", description=" --> NCTS_IMPORT_BASE_FETCH_SPECIFIC_TOPIC_UNLOADING_ITEM_URL")
	...
	//mode=D (Delete existing topic)
	//--------------------------------------------
	@UrlDataStoreAnnotationForField (name="@SkatNctsImportUnloadingItemsController - skatnctsimport_unloading_edit_items.do ", description=" --> NCTS_IMPORT_BASE_UPDATE_TOPIC_UNLOADING_ITEM_URL")
	...
	@UrlDataStoreAnnotationForField (name="@SkatNctsImportHeaderLoggingController - skatnctsimport_logging.do ", description=" --> NCTS_IMPORT_BASE_LOG_LIST_FOR_SPECIFIC_TOPIC_URL")
	...
	@UrlDataStoreAnnotationForField (name="@SkatNctsImportHeaderLoggingController - skatncts_import_renderLargeText.do ", description=" --> NCTS_IMPORT_BASE_LOG_LARGE_TEXT_FOR_SPECIFIC_TOPIC_URL")
	...
	@UrlDataStoreAnnotationForField (name="@SkatNctsImportHeaderArchiveController - skatnctsimport_archive.do ", description=" --> NCTS_IMPORT_BASE_ARCHIVE_FOR_SPECIFIC_TOPIC_URL")
	...
	//-----------------------------
	@UrlDataStoreAnnotationForField (name="@SkatNctsImportHeaderController - skatnctsimport_updateStatus.do ", description=" --> NCTS_IMPORT_BASE_UPDATE_STATUS_URL")
