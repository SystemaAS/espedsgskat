...
/**
 * 
 * SKAT-NCTS Export Topic Archive Controller 
 * 
...
public class SkatNctsExportHeaderArchiveController {
	 ...
	 * @return
	 */
	@RequestMapping(value="skatnctsexport_archive.do",  method= RequestMethod.GET)
	public ModelAndView doShowList(HttpSession session, HttpServletRequest request){
		Map model = new HashMap();
		SystemaWebUser appUser = (SystemaWebUser)session.getAttribute(AppConstants.SYSTEMA_WEB_USER_KEY);
		//String messageFromContext = this.context.getMessage("user.label",new Object[0], request.getLocale());
		ModelAndView successView = new ModelAndView("skatnctsexport_archive");
		logger.info("Method: doShowList [RequestMapping-->skatnctsexport_archive.do]");
	 ...
	 * @return
	 */
	@RequestMapping(value="skatncts_export_renderArchive.do", method={ RequestMethod.GET })
	public ModelAndView doSkatNctsExportRenderArchive(HttpSession session, HttpServletRequest request, HttpServletResponse response){
		logger.info("Inside doSkatNctsExportRenderArchive...");
		SystemaWebUser appUser = (SystemaWebUser)session.getAttribute(AppConstants.SYSTEMA_WEB_USER_KEY);
