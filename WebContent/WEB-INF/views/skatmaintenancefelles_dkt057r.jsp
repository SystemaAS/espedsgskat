			...
			<tr height="2"><td></td></tr>
				<tr height="25"> 
					...
					<td width="20%" valign="bottom" class="tab" align="center">
						<font class="tabLink">Valutakurser</font>&nbsp;<font class="text14">DKT057 / DKTVK</font>&nbsp;
				...
				<table id="containerdatatableTable" width="98%" cellspacing="1" border="0" align="left">
						...
						<table id="mainList" class="display compact cell-border" >
				            ...
				            <c:forEach var="record" items="${model.list}" varStatus="counter">   
				               ...
				               <td class="tableCell" style="border-style: solid;border-width: 0px 1px 1px 1px;border-color:#FAEBD7;"><font class="text14">&nbsp;${record.dkvk_kd}&nbsp;</font></td>
				               <td class="tableCell" style="border-style: solid;border-width: 0px 1px 1px 0px;border-color:#FAEBD7;" ><font class="text14">&nbsp;${record.dkvk_krs}&nbsp;</font></td>
				               <td class="tableCell" style="border-style: solid;border-width: 0px 1px 1px 0px;border-color:#FAEBD7;" ><font class="text14">&nbsp;${record.dkvk_omr}&nbsp;</font></td>
				               <td class="tableCell" style="border-style: solid;border-width: 0px 1px 1px 0px;border-color:#FAEBD7;" ><font class="text14">&nbsp;${record.dkvk_dts}&nbsp;</font></td>
				               <td class="tableCell" style="border-style: solid;border-width: 0px 1px 1px 0px;border-color:#FAEBD7;" ><font class="text14">&nbsp;${record.dkvk_dte}&nbsp;</font></td>
	 	    ...
	 	    <tr >
				...
				<form action="skatmaintenancefelles_dkt057r_edit.do" name="formRecord" id="formRecord" method="POST" >
					...
					<table width="80%" cellspacing="1" border="0" align="left">
			    	    <tr>
							<td class="text14" title="DKVK_KD">&nbsp;<font class="text14RedBold" >*</font>Sort</td>
							<td class="text14" title="DKVK_KRS">&nbsp;<font class="text14RedBold" >*</font>Kurs</td>
							<td class="text14" title="DKVK_OMR">&nbsp;<font class="text14RedBold" >*</font>Faktor</td>
							<td class="text14" title="DKVK_DTS">&nbsp;<font class="text14RedBold" >*</font>Fra</td>
							<td class="text14" title="DKVK_DTE">&nbsp;Til</td>
						</tr>
						<tr>
