 ...
 * 
 */
package no.systema.skat.skatimport.service.html.dropdown;
...
public class SkatImportDropDownListPopulationService {
	private static final Logger logger = LoggerFactory.getLogger(SkatImportDropDownListPopulationService.class.getName());
