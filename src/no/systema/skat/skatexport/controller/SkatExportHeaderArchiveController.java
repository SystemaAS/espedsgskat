...
/**
 * 
 * Skat Export Topic Archive Controller 
 * 
...
@Controller
@Scope("session")
public class SkatExportHeaderArchiveController {
	
	private static final Logger logger = LoggerFactory.getLogger(SkatExportHeaderArchiveController.class.getName());
	 ...
	 * @return
	 */
	@RequestMapping(value="skatexport_archive.do",  method= RequestMethod.GET)
	public ModelAndView doShowList(HttpSession session, HttpServletRequest request){
		Map model = new HashMap();
		SystemaWebUser appUser = (SystemaWebUser)session.getAttribute(AppConstants.SYSTEMA_WEB_USER_KEY);
		//String messageFromContext = this.context.getMessage("user.label",new Object[0], request.getLocale());
		ModelAndView successView = new ModelAndView("skatexport_archive");
		logger.info("Method: doShowList [RequestMapping-->skatexport_archive.do]");
		...
		if(appUser==null){
			...
			logger.info(Calendar.getInstance().getTime() + " CGI-start timestamp");
		    	...
		    	if(jsonPayload!=null){
		    		JsonSkatImportSpecificTopicArchiveContainer container = this.skatImportSpecificTopicService.getSkatImportSpecificTopicArchiveContainer(jsonPayload);
	 ...
	 * @return
	 */
	@RequestMapping(value="skat_export_renderArchive.do", method={ RequestMethod.GET })
	public ModelAndView doSkatExportRenderArchive(HttpSession session, HttpServletRequest request, HttpServletResponse response){
		logger.info("Inside doSkatExportRenderArchive...");
		SystemaWebUser appUser = (SystemaWebUser)session.getAttribute(AppConstants.SYSTEMA_WEB_USER_KEY);
