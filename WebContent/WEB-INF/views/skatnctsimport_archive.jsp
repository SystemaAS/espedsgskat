...
<!-- =====================end header ==========================-->
<SCRIPT type="text/javascript" src="resources/js/skatnctsimport_archive.js?ver=${user.versionEspedsg}"></SCRIPT>
			...
			<tr>
				...
				<table width="100%" cellspacing="0" border="0" cellpadding="0">
					...
					<tr class="tableHeaderField" height="20" valign="left">
	                    ...
	                    <th class="tableHeaderFieldFirst">&nbsp;<spring:message code="systema.skat.ncts.import.archive.list.label.topicNr"/>&nbsp;</th>
	                    <th class="tableHeaderField">&nbsp;<spring:message code="systema.skat.ncts.import.archive.list.label.docType"/>&nbsp;</th> 
	                    <th class="tableHeaderField">&nbsp;<spring:message code="systema.skat.ncts.import.archive.list.label.subject"/>&nbsp;</th> 
	                    <th class="tableHeaderField">&nbsp;<spring:message code="systema.skat.ncts.import.archive.list.label.date"/>&nbsp;</th>
	                    <th class="tableHeaderField">&nbsp;<spring:message code="systema.skat.ncts.import.archive.list.label.time"/>&nbsp;</th>
	                    <th class="tableHeaderField">&nbsp;<spring:message code="systema.skat.ncts.import.archive.list.label.additionalInfo"/>&nbsp;</th>
