...
/**
 * SKAT NCTS Import Header Controller - child windows popup
 * 
...
@Scope("session")
public class SkatNctsImportHeaderControllerChildWindow {
	
	private static final Logger logger = LoggerFactory.getLogger(SkatNctsImportHeaderControllerChildWindow.class.getName());
	 ...
	 * @return
	 */
	@RequestMapping(value="skatnctsimport_edit_childwindow_tullkontor.do", params="action=doInit",  method={RequestMethod.GET, RequestMethod.POST} )
	public ModelAndView doInitTullkontor(@ModelAttribute ("record") JsonSkatTullkontorRecord recordToValidate, HttpSession session, HttpServletRequest request){
		...
		ModelAndView successView = new ModelAndView("skatnctsimport_edit_childwindow_tullkontor");
	 ...
	 * @return
	 */
	@RequestMapping(value="skatnctsimport_edit_childwindow_generalcodes.do", params="action=doInit",  method={RequestMethod.GET} )
	public ModelAndView doInitGeneralCodes(@ModelAttribute ("record") JsonSkatNctsCodeRecord recordToValidate, HttpSession session, HttpServletRequest request){
		...
		ModelAndView successView = new ModelAndView("skatnctsimport_edit_childwindow_generalcodes");
		SystemaWebUser appUser = this.loginValidator.getValidUser(session);
		//check user (should be in session already)
		if(appUser==null){
			return this.loginView;
