 ...
 * 
 */
package no.systema.skat.z.maintenance.main.mapper.url.request;
				...
				try{
					if(field!=null){
						...
						if(value==null){
							...
							sb.append(SkatMaintenanceConstants.URL_CHAR_DELIMETER_FOR_PARAMS_WITH_HTML_REQUEST + field.getName() + "=");
