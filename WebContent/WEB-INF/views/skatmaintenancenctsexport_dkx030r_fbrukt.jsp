			...
			<tr height="2"><td></td></tr>
				<tr height="25"> 
					...
					<td width="20%" valign="bottom" class="tabDisabled" align="center">
						<a id="alinkRecordId_${counter.count}" onClick="setBlockUI(this);" href="skatmaintenancenctsexport_dkx030r.do?id=DKXGH">
					...
					<td width="20%" valign="bottom" class="tab" align="center">
						<font class="tabLink">Frigivelse af Garanti
		...
		<%-- space separator --%>
	 	    ...
	 	    <tr >
				...
				<td width="100%" class="text14">
					<form action="skatmaintenancenctsexport_dkx030r_fbrukt.do?id=DKXH" name="formRecordSearch" id="formRecordSearch" method="POST" >
					...
					<label nowrap class="inputTextMediumBlue11 isa_warning">
						Fritagelse for garanti gælder kun for gennemførte transitter (status: <b>P</b> = 029 eller <b>Z</b> = 045)
					</label>
					...
					<div class="text12" style="position: relative;" align="left">
 					<span style="position:absolute;top:2px; width:250px;" id="g_info" class="popupWithInputText text12"  >
	           			Søg efter et garantinummer for at se alle aktive og inaktive garantibeløb.	
				...
				<table id="containerdatatableTable" width="98%" cellspacing="1" border="0" align="left">
						...
						<table id="mainList" class="display compact cell-border" >
							...
							<tr>
			                    ...
			                    <th class="tableHeaderField" >&nbsp;Angiv.&nbsp;</th>
								<th class="tableHeaderField" >&nbsp;Sign&nbsp;</th>
								<th class="tableHeaderField" >&nbsp;Dato&nbsp;</th>
								<th class="tableHeaderField" >&nbsp;Deadline&nbsp;</th>
								<th class="tableHeaderField" >&nbsp;Garantinr&nbsp;</th>
								<th class="tableHeaderField" >&nbsp;Tillg.kode&nbsp;</th>
								<th class="tableHeaderField" >&nbsp;Garantibeløb&nbsp;</th>
								<th class="tableHeaderField" >&nbsp;Møntsort&nbsp;</th>
				            ...
				            <c:forEach var="record" items="${model.list}" varStatus="counter">   
				               ...
				               <c:choose>
					               ...
					               <c:otherwise>
					               		<td style="cursor:crosshair" title="Aktiv garanti. Kan ikke frigives endnu." align="center"><img src="resources/images/bulletGreen.png" width="10" height="10" border="0" alt="edit"></td>
						           </c:otherwise>
				               </c:choose>
				               ...
				               <td class="tableCell" style="border-style: solid;border-width: 0px 1px 1px 0px;border-color:#FAEBD7;" >
				               		...
				               		<a href="skatnctsexport_edit.do?action=doFetch&avd=${record.thavd}&opd=${record.thtdn}&sysg=${record.thsg}&tuid=&syst=${record.thst}&sydt=${record.thdt}">
				               			&nbsp;${record.thtdn}&nbsp;
				               		</a>	
				               </td>
			...
			<tr height="2"><td>&nbsp;</td></tr>
	 	    ...
	 	    <tr >
	 	    	<td width="5%">&nbsp;</td>
				<td width="100%">
				<form action="skatmaintenancenctsexport_dkx030r_fbrukt_edit.do" name="formRecord" id="formRecord" method="POST" >
					...
					<table width="60%" cellspacing="1" border="0" align="left">
						<tr>
								...
								<td class="text14" title="thtdn">&nbsp;Angiv.</td>
								<td class="text14" title="thsg">&nbsp;Sign</td>
								<td class="text14" title="thdt">&nbsp;Dato</td>
								<td class="text14" title="thddt">&nbsp;Deadline</td>
								<td class="text14" title="thgft1">&nbsp;Garantinr</td>
								<td class="text14" title="thgbl">&nbsp;Garantibeløb</td>
						</tr>
						<tr>	
								...
								<td><input class="inputFormSubmit" type="submit" name="submit" id="submit" value='<spring:message code="systema.skat.release"/>'/></td>				
						</tr>
