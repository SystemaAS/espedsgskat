...
/**
 * SKAT NCTS Import Items Controller - child windows popup
 * 
...
@Scope("session")
public class SkatNctsImportItemsControllerChildWindow {
	
	private static final Logger logger = LoggerFactory.getLogger(SkatNctsImportItemsControllerChildWindow.class.getName());
	 ...
	 * @return
	 */
	@RequestMapping(value="skatnctsimport_edit_items_childwindow_generalcodes.do", params="action=doInit",  method={RequestMethod.GET} )
	public ModelAndView doInitGeneralCodes(@ModelAttribute ("record") JsonSkatNctsCodeRecord recordToValidate, HttpSession session, HttpServletRequest request){
		...
		ModelAndView successView = new ModelAndView("skatnctsimport_edit_items_childwindow_generalcodes");
