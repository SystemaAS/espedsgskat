	...
	public ModelAndView doShowList(HttpSession session, HttpServletRequest request){
		...
		if(appUser==null){
			...
			logger.info(Calendar.getInstance().getTime() + " CGI-start timestamp");
		    	...
		    	if(jsonPayload!=null){
		    		JsonSkatNctsExportSpecificTopicLoggingContainer jsonNctsExportSpecificTopicLoggingContainer = this.skatNctsExportSpecificTopicService.getNctsExportSpecificTopicLoggingContainer(jsonPayload);
				...
				successView.addObject(SkatConstants.DOMAIN_LIST,jsonNctsExportSpecificTopicLoggingContainer.getLogg());
