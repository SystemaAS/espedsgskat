...
<!-- =====================end header ==========================-->
	...
	<SCRIPT type="text/javascript" src="resources/js/skatmaintenanceimport_dkg210d.js?ver=${user.versionEspedsg}"></SCRIPT>	
			...
			<tr height="2"><td></td></tr>
				<tr height="25"> 
					<td width="20%" valign="bottom" class="tabDisabled" align="center" nowrap>
						<a id="alinkSadMaintExportGate" tabindex=-1 style="display:block;" href="skatmaintenanceimport.do">
					...
					<td width="20%" valign="bottom" class="tabDisabled" align="center" nowrap>
						<a id="alinkSadMaintExportKoder" tabindex=-1 style="display:block;" href="skatmaintenanceimport_kodergate.do?id=DKTKD">
		...
		<%-- space separator --%>
						...
						<table id="mainList" class="display compact cell-border" >
				            ...
				            <c:forEach var="record" items="${model.list}" varStatus="counter">   
				               ...
				               <td align="center" width="2%" class="tableCell" style="cursor:pointer; border-style: solid;border-width: 0px 1px 1px 0px;border-color:#FAEBD7;">
		               				<a onclick="javascript:return confirm('Er du sikker på at du vil fjerne denne?')" tabindex=-1 href="skatmaintenanceimport_dkg210d_edit.do?action=doDelete&id=${model.dbTable}&dkkd_typ=${record.dkkd_typ}&dkkd_kd=${record.dkkd_kd}">
			...
			<tr >
	 	    ...
	 	    <tr >
	 	    	<td width="5%">&nbsp;</td>
				<td width="100%">
				<form action="skatmaintenanceimport_dkg210d_edit.do" name="formRecord" id="formRecord" method="POST" >
