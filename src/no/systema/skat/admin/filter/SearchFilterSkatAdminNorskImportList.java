 ...
 * 
 */
package no.systema.skat.admin.filter;
 ...
 * @date 	Feb 20, 2014
 */
public class SearchFilterSkatAdminNorskImportList {
	private static final Logger logger = LoggerFactory.getLogger(SearchFilterSkatAdminNorskImportList.class.getName());
