...
public class SkatNctsImportHeaderArchiveController {
	...
	private static final Logger logger = LoggerFactory.getLogger(SkatNctsImportHeaderArchiveController.class.getName());
	...
	public ModelAndView doShowList(HttpSession session, HttpServletRequest request){
		...
		if(appUser==null){
			...
			logger.info(Calendar.getInstance().getTime() + " CGI-start timestamp");
		    	...
		    	if(jsonPayload!=null){
		    		JsonSkatNctsImportSpecificTopicArchiveContainer container = this.skatNctsImportSpecificTopicService.getNctsImportSpecificTopicArchiveContainer(jsonPayload);
