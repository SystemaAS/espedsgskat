package no.systema.skat.nctsimport.controller.view;
...
public class SkatNctsImportMainListViewController {
	private static final Logger logger = Logger.getLogger(SkatNctsImportMainListViewController.class.getName());
	 ...
	 * 
	 */
	@RequestMapping(value="skatNctsImportMainListExcelView.do", method={RequestMethod.GET})
	public ModelAndView getItemListExcelView(HttpSession session, HttpServletRequest request, HttpServletResponse response){
		...
		final String EXCEL_VIEW = "skatNctsImportMainListExcelView";
		
		SystemaWebUser appUser = (SystemaWebUser)session.getAttribute(AppConstants.SYSTEMA_WEB_USER_KEY);
		List<JsonSkatNctsImportTopicListRecord> mainList = null;
