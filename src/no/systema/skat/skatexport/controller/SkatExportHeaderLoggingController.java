...
public class SkatExportHeaderLoggingController {
	...
	private static final Logger logger = LoggerFactory.getLogger(SkatExportHeaderLoggingController.class.getName());
	...
	public ModelAndView doShowList(HttpSession session, HttpServletRequest request){
		...
		if(appUser==null){
			...
			logger.info(Calendar.getInstance().getTime() + " CGI-start timestamp");
		    	...
		    	if(jsonPayload!=null){
		    		JsonSkatExportSpecificTopicLoggingContainer container = this.skatExportSpecificTopicService.getSkatExportSpecificTopicLoggingContainer(jsonPayload);
	...
	@RequestMapping(value="skat_export_renderXml.do", method={ RequestMethod.GET })
	public ModelAndView doSkatExportRenderXml(HttpSession session, HttpServletRequest request, HttpServletResponse response){
		logger.info("Inside doSkatExportRenderXml...");
		SystemaWebUser appUser = (SystemaWebUser)session.getAttribute(AppConstants.SYSTEMA_WEB_USER_KEY);
