...
import no.systema.skat.admin.filter.SearchFilterSkatAdminTransportList;
import no.systema.skat.admin.validator.SkatAdminTransportListValidator;
...
/**
 * SKAT Admin Transport Controller 
 * 
...
public class SkatAdminTransportController {
	...
	private static final Logger logger = LoggerFactory.getLogger(SkatAdminTransportController.class.getName());
	 ...
	 * @return
	 */
	@RequestMapping(value="skatadmin_transport.do", method=RequestMethod.GET)
	public ModelAndView doSkatExportList(HttpSession session, HttpServletRequest request){
		ModelAndView successView = new ModelAndView("skatadmin_transport");
		SystemaWebUser appUser = (SystemaWebUser)session.getAttribute(AppConstants.SYSTEMA_WEB_USER_KEY);
		SearchFilterSkatAdminTransportList searchFilter = new SearchFilterSkatAdminTransportList();
	 ...
	 * @return
	 */
	@RequestMapping(value="skatadmin_transport", params="action=doFind",  method={RequestMethod.GET, RequestMethod.POST} )
	public ModelAndView doFind(@ModelAttribute ("record") SearchFilterSkatAdminTransportList recordToValidate, BindingResult bindingResult, HttpSession session, HttpServletRequest request){
		...
		if(appUser==null){
			...
			//Validation
			//-----------
			SkatAdminTransportListValidator validator = new SkatAdminTransportListValidator();
			...
			if(bindingResult.hasErrors()){
	            ...
	            //get BASE URL
		    		final String BASE_URL = SkatAdminUrlDataStore.SKAT_ADMIN_BASE_TRANSPORT_LIST_URL;
		    		//add URL-parameters
				...
				logger.info(jsonPayload);
			    	...
			    	if(jsonPayload!=null){
			    		JsonSkatAdminTransportListContainer jsonSkatAdminTransportListContainer = this.skatAdminTransportService.getSkatAdminTransportListContainer(jsonPayload);
					//-----------------------------------------------------------
	 ...
	 * @return
	 */
	private String getRequestUrlKeyParameters(SearchFilterSkatAdminTransportList searchFilter, SystemaWebUser appUser){
		StringBuffer urlRequestParamsKeys = new StringBuffer();
